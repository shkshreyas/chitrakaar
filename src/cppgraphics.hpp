#ifndef chitrakaar_HPP_INCLUDE_GUARD
#define chitrakaar_HPP_INCLUDE_GUARD
...
namespace cg
{
    ...
    ///////////////////////////////////////////////////////////////////////////////
    //
    // chitrakaar is a simple C++ library to provide access to graphics output and
    // keyboard / mouse on Windows, Linux and macOS (experimentally Emscripten).
    //
    // See https://github.com/shkshreyas/chitrakaar
    //
    ...
    // chitrakaar.cpp must be a part of the project):
    //
    ...
    void create_window(const std::string &title = "chitrakaar window",
    ...
    // chitrakaar is single threaded and in order to keep the window responsive,
    ...
    // chitrakaar holds a list of currently active attributes, which are used
...
#define chitrakaar_VERSION_MAJOR 1
#define chitrakaar_VERSION_MINOR 0
#define chitrakaar_VERSION_PATCH 1

#endif // chitrakaar_HPP_INCLUDE_GUARD
